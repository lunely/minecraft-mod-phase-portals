...
public final class TeleportScreenHandler extends ScreenHandler {
    private final TeleportBlockEntity teleport;
    private final Inventory anchorInventory;
    private final PropertyDelegate energyProperties;

    public TeleportScreenHandler(int syncId, PlayerInventory inventory) {
        this(syncId, inventory, null, new SimpleInventory(1),
                new ArrayPropertyDelegate(PEPropertyCodec.PROPERTY_COUNT));
    }

    public TeleportScreenHandler(int syncId, PlayerInventory inventory, TeleportBlockEntity teleport) {
    ...
    private TeleportScreenHandler(int syncId, PlayerInventory playerInventory, TeleportBlockEntity teleport,
            Inventory anchorInventory, PropertyDelegate energyProperties) {
        super(PhasePortalsMod.TELEPORT_SCREEN_HANDLER, syncId);
    ...
    public TeleportBlockEntity teleport() { return teleport; }
